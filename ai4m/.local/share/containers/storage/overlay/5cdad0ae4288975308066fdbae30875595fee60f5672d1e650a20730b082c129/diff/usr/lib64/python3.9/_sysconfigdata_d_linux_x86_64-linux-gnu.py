...
build_time_vars = {'ABIFLAGS': 'd',
 ...
 'CONFIG_ARGS': "'--build=x86_64-redhat-linux-gnu' "
                ...
                "'--with-builtin-hashlib-hashes=blake2' '--with-valgrind' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/builddir/build/BUILD/Python-3.9.21/build/debug/coverage.info',
 'COVERAGE_REPORT': '/builddir/build/BUILD/Python-3.9.21/build/debug/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             '-I/builddir/build/BUILD/Python-3.9.21/Include',
 'CXX': 'g++',
 ...
 'MAKESETUP': '/builddir/build/BUILD/Python-3.9.21/Modules/makesetup',
 ...
 'OPT': '-DDYNAMIC_ANNOTATIONS_ENABLED=1  -O2  -fexceptions -g '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             '-DDYNAMIC_ANNOTATIONS_ENABLED=1  -O2  '
                             ...
                             '-mtune=generic -fasynchronous-unwind-tables '
                             '-fstack-clash-protection -fcf-protection '
                             '-D_GNU_SOURCE -fPIC -fwrapv  -O0 -Wno-cpp -O2 '
                             ...
                             '-fstack-clash-protection -fcf-protection '
                             '-D_GNU_SOURCE -fPIC -fwrapv '
                             '-fno-semantic-interposition -O0 -Wno-cpp  '
                             '-I/builddir/build/BUILD/Python-3.9.21/Include/internal '
                             '-IObjects -IInclude -IPython -I. '
                             '-I/builddir/build/BUILD/Python-3.9.21/Include '
                             '-fPIC -DPy_BUILD_CORE_BUILTIN',
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare '
              '-DDYNAMIC_ANNOTATIONS_ENABLED=1  -O2  -fexceptions -g '
              '-grecord-gcc-switches -pipe -Wall -Werror=format-security '
              '-Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS  '
              '-fstack-protector-strong   -m64 -march=x86-64-v2 -mtune=generic '
              '-fasynchronous-unwind-tables -fstack-clash-protection '
              ...
              '-fstack-protector-strong   -m64 -march=x86-64-v2 -mtune=generic '
              '-fasynchronous-unwind-tables -fstack-clash-protection '
              '-fcf-protection -D_GNU_SOURCE -fPIC -fwrapv  -O0 -Wno-cpp',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                   ...
                   '-mtune=generic -fasynchronous-unwind-tables '
                   '-fstack-clash-protection -fcf-protection -D_GNU_SOURCE '
                   '-fPIC -fwrapv  -O0 -Wno-cpp -O2 -flto=auto '
                   ...
                   '-I/builddir/build/BUILD/Python-3.9.21/Include/internal '
                   '-IObjects -IInclude -IPython -I. '
                   '-I/builddir/build/BUILD/Python-3.9.21/Include -fPIC '
                   '-DPy_BUILD_CORE',
 ...
 'PY_LDFLAGS_NODIST': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now '
                      ...
                      '-fno-semantic-interposition -g  -flto '
                      '-fuse-linker-plugin -ffat-lto-objects '
                      '-flto-partition=none -g -Wl,-z,relro -Wl,--as-needed  '
                      '-Wl,-z,now '
                      '-specs=/usr/lib/rpm/redhat/redhat-hardened-ld '
                      '-specs=/usr/lib/rpm/redhat/redhat-annobin-cc1  '
                      '-fno-semantic-interposition -g',
 ...
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                        ...
                        '-m64 -march=x86-64-v2 -mtune=generic '
                        '-fasynchronous-unwind-tables -fstack-clash-protection '
                        '-fcf-protection -D_GNU_SOURCE -fPIC -fwrapv  -O0 '
                        '-Wno-cpp -O2 -flto=auto -ffat-lto-objects '
                        '-fexceptions -g -grecord-gcc-switches -pipe -Wall '
                        '-Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 '
                        '-Wp,-D_GLIBCXX_ASSERTIONS '
                        '-specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.9.21/build/debug',
 'SCRIPTDIR': '/usr/lib64',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'SRC_GDB_HOOKS': '/builddir/build/BUILD/Python-3.9.21/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.9.21/build/debug '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.9.21/build/debug '
               './python '
               '/builddir/build/BUILD/Python-3.9.21/Tools/scripts/run_tests.py',
 'TESTTIMEOUT': 1200,
 'TIMEMODULE_LIB': 0,
 ...
 'UPDATE_FILE': 'python3.9 '
                '/builddir/build/BUILD/Python-3.9.21/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 1,
 'VERSION': '3.9',
 'VPATH': '/builddir/build/BUILD/Python-3.9.21',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/builddir/build/BUILD/Python-3.9.21/build/debug',
 'abs_srcdir': '/builddir/build/BUILD/Python-3.9.21',
 'datarootdir': '/usr/share',
 'exec_prefix': '/usr',
 'prefix': '/usr',
 'srcdir': '/builddir/build/BUILD/Python-3.9.21'}
